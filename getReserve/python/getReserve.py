...
address = "0x6927ed4dAccd02cF3695Ce0820C986C3E024E895"

contract = w3.eth.contract(address=address, **get_abi("getReserve/build/contracts/getReserve.json"))

contract.all_functions()

contract.functions.get(["0xc31Ba270fb641117DAA535498D60E6C0BCc214f5", "0xc31Ba270fb641117DAA535498D60E6C0BCc214f5"]).call()


contract.functions.getOnlyOne("0xc31Ba270fb641117DAA535498D60E6C0BCc214f5").call()
