...
address = "0x957A4Da897A14AcdC4b8D870F4D60565F9b04064"

contract = w3.eth.contract(address=address, **get_abi("favoritenumber/build/contracts/FavoriteAddress.json"))
contract.functions.getFavoriteAddress().call()
# Ceci ne marche pas  -- contract.functions.setFavoriteNumber(42).call()

txn = contract.functions.setFavoriteAddress(
    "0xBDECd20378cD81Fca7888D7767a43AB81174fa7e",
).build_transaction({
