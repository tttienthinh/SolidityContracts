...
address = "0xA40096A6a3F953A78c4E9F73Cc671167479eF04E"

contract = w3.eth.contract(address=address, **get_abi("tests/build/contracts/ExistingNoSet.json"))

contract.all_functions()

contract.functions.getA("0xBbe9C79D188999D6a445A4b74E3aDd68d725719b").call()

txn = contract.functions.setA(
    "0xBbe9C79D188999D6a445A4b74E3aDd68d725719b", 15
).build_transaction({
